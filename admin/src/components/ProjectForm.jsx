...
export default function ProjectForm({ projectToEdit, onSuccess, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (projectToEdit) {
        await axios.put(`https://manav-s-portfolio.onrender.com/api/admin/projects/${projectToEdit._id}`, data, config);
      } else {
        await axios.post('https://manav-s-portfolio.onrender.com/api/admin/projects', data, config);
      }
      onSuccess();
    } catch (err) {
